...
const notasFiscais = [
  { id: 1, numero: "NFS-001", destinatario: "Ana Souza", valor: "R$ 1.200,00", data: "13/09/2026", status: "Emitida" },
  { id: 2, numero: "NFS-002", destinatario: "Pedro Lima", valor: "R$ 450,00", data: "13/09/2026", status: "Emitida" },
  { id: 3, numero: "NFS-003", destinatario: "Empresa ABC", valor: "R$ 8.500,00", data: "11/09/2026", status: "Cancelada" },
];

const recibos = [
  { id: 1, numero: "REC-001", destinatario: "João Silva", valor: "R$ 380,00", data: "12/09/2026", status: "Emitido" },
  { id: 2, numero: "REC-002", destinatario: "Maria Costa", valor: "R$ 250,00", data: "11/09/2026", status: "Emitido" },
];
...
export default function Fiscal() {
  ...
  return (
    <div className="space-y-4">
      ...
      {tab === "dadosfiscais" && (
        <Card>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Input label="Razão Social" defaultValue="Hotel Pacaas Novos LTDA" />
            ...
            <div className="col-span-2">
              <Input label="Endereço" defaultValue="Av. das Palmeiras, 1000 — Porto Velho/RO" />
            </div>
          </div>
      ...
      {tab === "notasfiscais" && (
        <Card>
          <div className="flex justify-between items-center mb-4">
            ...
            <Btn small onClick={() => setModal("nf")}>+ Emitir NFS</Btn>
          </div>
          <Table
            headers={["Número", "Destinatário", "Valor", "Data", "Status", "Ações"]}
            rows={notasFiscais.map((n) => [
              ...
              <div className="flex gap-1">
                <Btn small variant="ghost">Consultar</Btn>
                {n.status !== "Cancelada" && (
                  <>
                    <Btn small variant="secondary">Reemitir</Btn>
      ...
      {tab === "recibos" && (
        <Card>
          <div className="flex justify-between items-center mb-4">
            ...
            <Btn small onClick={() => setModal("recibo")}>+ Emitir Recibo</Btn>
          </div>
          <Table
            headers={["Número", "Destinatário", "Valor", "Data", "Status", "Ações"]}
            rows={recibos.map((r) => [
      ...
      {modal && (
        <Modal title={modal === "nf" ? "Emitir Nota Fiscal" : "Emitir Recibo"} onClose={() => setModal(null)}>
          <div className="space-y-4">
