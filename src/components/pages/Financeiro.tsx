...
const contasPagar = [
  {
    id: 1,
    descricao: "Fornecedor lavanderia",
    valor: "R$ 1.200,00",
...
const contasReceber = [
  {
    id: 1,
    descricao: "Reserva #1001 — Ana Souza",
    valor: "R$ 1.200,00",
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
      ...
      {tab === "pagar" && (
        <Card>
          ...
          >
            ...
            <Btn small onClick={() => setModal("pagar")}>
              + Nova Conta
            </Btn>
          </div>
          <Table
            ...
            rows={contasPagar.map((c) => [
              ...
              <Badge
                label={c.situacao}
                color={situacaoColor[c.situacao] ?? "gray"}
              />,
      ...
      {tab === "receber" && (
        <Card>
          ...
          >
            ...
            <Btn small onClick={() => setModal("receber")}>
              + Nova Conta
            </Btn>
          </div>
          <Table
        ...
        <Card>
          ...
          >
            ...
            <div style={{ display: "flex", gap: "8px" }}>
              <Btn small onClick={() => setModal("caixa")}>
                Abrir Caixa
              </Btn>
              <Btn small variant="secondary">
                Fechar Caixa
        ...
        <Card>
          ...
          <Table
            ...
            rows={[
              [
                "12/09/2026",
                "PIX recebido — Pedro Lima",
                "R$ 450,00",
                "R$ 450,00",
                <Badge label="Conciliado" color="green" />,
              ],
              [
                "11/09/2026",
                "TED fornecedor lavanderia",
                "R$ 1.200,00",
                "R$ 1.200,00",
                <Badge label="Conciliado" color="green" />,
              ],
      ...
      {(modal === "pagar" || modal === "receber") && (
        <Modal
          title={
            modal === "pagar" ? "Nova Conta a Pagar" : "Nova Conta a Receber"
          }
