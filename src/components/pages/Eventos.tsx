...
const eventos = [
  {
    ...
    sala: "Sala A",
    inicio: "2026-09-20 09:00",
    fim: "2026-09-20 18:00",
    status: "Confirmado",
    valor: "R$ 8.500,00",
  },
  {
    ...
    inicio: "2026-10-05 16:00",
    fim: "2026-10-06 02:00",
    status: "Aguardando",
    valor: "R$ 22.000,00",
  },
]
...
const servicos = [
  {
    id: 1,
    nome: "Coffee Break",
    descricao: "Café, sucos e salgadinhos",
    valor: "R$ 45,00/pax",
    status: "Ativo",
  },
  {
    id: 2,
    nome: "Projetor",
    descricao: "Projetor Full HD + tela",
    valor: "R$ 300,00/dia",
    status: "Ativo",
  },
  {
    id: 3,
    nome: "Decoração",
    descricao: "Decoração personalizada",
    valor: "Sob consulta",
    status: "Ativo",
  },
]
        ...
        <Card>
          <Table
            ...
            rows={eventos.map((e) => [
              ...
              <Badge
                label={e.status}
                color={e.status === "Confirmado" ? "green" : "yellow"}
              />,
              <div className="flex gap-1">
        ...
        <Card>
          ...
          <Table
            ...
            rows={salas.map((s) => [
              ...
              <Badge
                label={s.status}
                color={s.status === "Disponível" ? "green" : "yellow"}
              />,
              <div className="flex gap-1">
                <Btn small variant="ghost">
                  Editar
