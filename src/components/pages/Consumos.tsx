...
const initialConsumos = [
  ...
  },
  {
    ...
    quarto: "101",
    servico: "Restaurante",
    descricao: "Jantar para 2",
    valor: "R$ 180,00",
    data: "13/09/2026 20:15",
  },
  {
    id: 4,
    hospede: "Ana Souza",
...
export default function Consumos() {
  ...
  const filtered = data.filter(
    (c) =>
      !search ||
      c.hospede.toLowerCase().includes(search.toLowerCase()) ||
      c.quarto.includes(search),
  )
