...
const initialPacotes = [
  ...
  },
  {
    id: 2,
    nome: "Pacote Família",
    descricao: "3 noites + café da manhã",
    valor: "R$ 2.400,00",
    vigencia: "2026-11-30",
    status: "Ativo",
  },
    ...
    <div className="space-y-4">
      <PageHeader
        ...
        actions={
          <Btn
            onClick={() => {
              setForm({ nome: "", descricao: "", valor: "", vigencia: "" })
              setModal(true)
            }}
          >
            + Novo Pacote
      ...
      <Card>
        <Table
          ...
          rows={pacotes.map((p) => [
            ...
            <Badge
              label={p.status}
              color={p.status === "Ativo" ? "green" : "gray"}
            />,
