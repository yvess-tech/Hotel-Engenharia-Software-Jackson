...
const alerts = [
  {
    msg: "Estoque de sabonetes abaixo do mínimo (12 un.)",
    icon: "⚠",
    type: "warning",
  },
  {
    msg: "Quarto 204 com manutenção pendente há 2 dias",
    icon: "🔴",
    type: "error",
  },
  {
    msg: "3 check-outs previstos para hoje sem fatura gerada",
    icon: "ℹ",
    type: "info",
  },
]
